...
public class ChildHealthInfo extends ActionBarActivity {
    Drawer.Result result;
    AccountHeader.Result headerResult;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_child_health_info);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            ...
                            if (drawerItem.getIdentifier() == 0) {
                                ...
                                startActivity(new Intent(ChildHealthInfo.this, MainActivity.class));
                                //Toast.makeText(getBaseContext(),"On Drawer Created",Toast.LENGTH_LONG).show();

                            } else if (drawerItem.getIdentifier() == 1) {
                                //fragment = new Calculator();
                                startActivity(new Intent(ChildHealthInfo.this,HealthCalculator.class));


                            } else if (drawerItem.getIdentifier() == 2) {

                                startActivity(new Intent(ChildHealthInfo.this, MotherHealthInfo.class));
                            }
                            else if (drawerItem.getIdentifier() == 3) {


                            } else if (drawerItem.getIdentifier() == 4) {
                                startActivity(new Intent(ChildHealthInfo.this, Hospital.class));
                            } else if (drawerItem.getIdentifier() == 5) {
                                startActivity(new Intent(ChildHealthInfo.this, EmergencyContact.class));
                            }
                            else if (drawerItem.getIdentifier() == 6) {
                                startActivity(new Intent(ChildHealthInfo.this, Vaccination.class));
                            }
                            if (fragment != null) {
...
//        getSupportActionBar().setHomeButtonEnabled(false);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_child_health_info, menu);
        return true;
    }
